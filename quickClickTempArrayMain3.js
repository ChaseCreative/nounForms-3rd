...
nounsThirdSing = [["reg", "king"], ["pac", "peace"],["labor", "work"], ["homin", "man"], ["virtut", "virtue"], ["civitat", "state"], ["can", "dog"], ["mercator", "merchant"], ["patr", "father"], ["matr", "mother"]];
nounsThirdSingIndx = Math.floor(Math.random() * nounsThirdSing.length);

nounsThirdPl = [["reg", "kings"], ["leg", "laws"],["labor", "works"], ["homin", "men"], ["virtut", "virtues"], ["civitat", "states"], ["can", "dogs"], ["mercator", "merchants"], ["patr", "fathers"], ["matr", "mothers"]];
nounsThirdPlIndx = Math.floor(Math.random() * nounsThirdPl.length);


  //var verbsFirstPer = [["Amav", "loved"], ["laborav", "worked"], ["habitav", "lived"], ["cogitav", "thought"], ["cantav", "sang"], ["ded", "gave"]];


pEThirdSing = [["is", "of the "], ["ī ", "to/for the "], ["em", "the "], ["e", "by/with/in/from the "]];
pEThirdSingIndx = Math.floor(Math.random() * pEThirdSing.length);

pEThirdPl = [["ēs (Nominative)", "the "], ["um", "of the "], ["ibus (Dative)", "to/for the "], ["ēs (Accusative)", "the "], ["ibus (Ablative)", "by/with/in/from the "], ["ēs! (Vocative)", "Oh, "]];
pEThirdPlIndx = Math.floor(Math.random() * pEThirdPl.length);

nounsSingLatinArray = nounsThirdSing[nounsThirdSingIndx][0] + pEThirdSing[pEThirdSingIndx][0];
nounsSingTransArray = pEThirdSing[pEThirdSingIndx][1] + nounsThirdSing[nounsThirdSingIndx][1];

nounsPlLatinArray = nounsThirdPl[nounsThirdPlIndx][0] + pEThirdPl[pEThirdPlIndx][0];
nounsPlTransArray = pEThirdPl[pEThirdPlIndx][1] + nounsThirdPl[nounsThirdPlIndx][1];
